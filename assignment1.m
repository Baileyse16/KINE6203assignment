...
%
% Answer: for statements and while statements 
% for statements loop a specific number of times, 
% and keep track of each iteration with an incrementing index variable.
